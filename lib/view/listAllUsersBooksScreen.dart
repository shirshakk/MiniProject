    ...
    return Scaffold(
      ...
      body: FutureBuilder<List<Book>>(
        future: bookController.listarLivros(
            email:
                _userController.user?.email ?? 'contato@clubedoautor.com.br'),
                    ...
                    child: GestureDetector(
                      onTap: () {
                        final BookDetailsController _bookDetailsController =
                            Get.put(BookDetailsController(livro));
                            ...
                            Container(
                              ...
                              decoration: BoxDecoration(
                                image: DecorationImage(
                                  image: AssetImage(
                                      'assets/images/book_template.png'), // caminho para sua imagem
                                  fit: BoxFit
                                      .cover, // isso faz com que a imagem cubra todo o espaço disponível
                                ),
                              ),
                            ),
