...
class _RegisterBookScreenState extends State<RegisterBookScreen> {
  ...
  bool _isCapa = false;
  String mensagem = 'The Cover has not been loaded yet!';
          ...
          children: <Widget>[
            Padding(
              ...
              child: TextFormField(
                ...
                decoration: InputDecoration(
                    labelText: 'Book\'s title', border: OutlineInputBorder()),
                validator: (value) {
            ...
            Padding(
              ...
              child: TextFormField(
                ...
                maxLines: null,
                decoration: InputDecoration(
                    labelText: 'Synopsis', border: OutlineInputBorder()),
                validator: (value) {
                  if (value == null || value.isEmpty) {
                    ...
                    onPressed: () async {
                      if (_formKey.currentState!.validate()) {
                        ...
                        if (capa != null) {
                          setState(() {
                            _isCapa = false;
                            mensagem = 'Cover loaded successfully!';
                          });
